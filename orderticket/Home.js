...
import { View, Text, StyleSheet, Image, FlatList, SafeAreaView, TouchableOpacity, ScrollView  } from 'react-native'
...
export default function Home({navigation}) {
  ...
  return (
    ...
    :
    <View>
      <Text style={{fontSize: 20, color: '#f4f4f5', marginTop: 5, marginLeft: 20, fontWeight: 'bold'}}>Now 
      ...
      <FlatList
        ...
        renderItem={(element) => {
            return (
                ...
                <Image
                    style={{width: 299 , height: 205, borderRadius: 14, resizeMode: 'cover',  marginRight: 8}}
                    source={{
                        uri: `https://image.tmdb.org/t/p/w500${element.item.poster_path}`,
                    }}
                />
      <Text style={{color: 'red', textAlign: 'center', top: -25, fontSize: 35}}>{element.item.title}</Text>
                </TouchableOpacity>
            )
        }}
      ...
      <Text style={{fontSize: 20, color: '#f4f4f5', marginLeft: 20, fontWeight: 'bold'}}>Coming
      <Text style={{color: '#7DD329'}}> Soon</Text>
      </Text>
      <FlatList
        showsHorizontalScrollIndicator={false}
        style={{marginTop: 20}}
        ...
        renderItem={(element) => {
            return (
              ...
              onPress={() => {
                ...
                <Image
                    style={{width: 120, height: 190, borderWidth: 1, borderRadius: 15, borderColor: 'blue', marginRight: 10}}
                    source={{
                        uri: `https://image.tmdb.org/t/p/w500${element.item.poster_path}`,
                    }}
                />
      ...
      />
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          ...
          <Text style={{color: '#7DD329', fontSize: 20, fontWeight: 'bold', marginLeft: 20}}> Promo</Text>
          <TouchableOpacity>
